...
//with join reply
const reply = (teks) => {
            ZarnBot.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` Join Bot's Official GC`,"body": ` Join Bot's Official GC`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": thumb,"sourceUrl": "https://chat.whatsapp.com/Ge3sbLp6saf1CGiPnp4Kuw"}}}, { quoted: m })
        }
/**
const reply = (teks) => {
